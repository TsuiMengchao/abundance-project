...
class RichText(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        super(RichText, self).__init__(*args, **kwargs)
    ...
    def openImage(self):
        try:
            ...
            if imgSize > 10485760:  # 将判断条件修改为以字节为单位的10MB大小限制
                QMessageBox.warning(self, "警告", "图片大小不能超过10MB！", QMessageBox.Yes)
                return
