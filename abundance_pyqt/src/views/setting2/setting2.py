# Form implementation generated from reading ui file 'C:\Work\Program\Codes\AutoTest\assets\ui\setting2.ui'
#
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 701, 591))
...
"background-color: rgb(39,60,81);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">驱动相关</span></p></body></html>"))
        self.label_8.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ffffff;\">浏览器地址：</span></p></body></html>"))
        self.pushButton_5.setText(_translate("Dialog", "···"))
        self.label_9.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ffffff;\">驱动类型：</span></p></body></html>"))
        self.lineEdit_4.setText(_translate("Dialog", "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe"))
        self.pushButton_6.setText(_translate("Dialog", "···"))
        self.label_7.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ffffff;\">驱动地址：</span></p></body></html>"))
        self.comboBox_2.setItemText(0, _translate("Dialog", "chrome"))
        self.comboBox_2.setItemText(1, _translate("Dialog", "edge"))
        self.lineEdit_5.setText(_translate("Dialog", "C:\\Work\\Program\\Codes\\AutoTest\\resources\\driver\\chromedriver-133.0.6943.53.exe"))
        self.label_13.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">报告相关</span></p></body></html>"))
        self.lineEdit_7.setText(_translate("Dialog", "%Y-%m-%d_%H-%M-%S"))
        self.label_16.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ffffff;\">报告名格式：</span></p></body></html>"))
        self.label_18.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ffffff;\">报告路径：</span></p></body></html>"))
        self.lineEdit_8.setText(_translate("Dialog", "target/report"))
        self.pushButton_2.setText(_translate("Dialog", "重置"))
        self.pushButton_4.setText(_translate("Dialog", "检查"))
